...
from model.modules import PathRNNEncoder, RNNDecoder
...
class CFGRNN2Seq(LightningModule):
    ...
    def _get_encoder(self) -> PathRNNEncoder:
        return PathRNNEncoder(
    ...
    def _get_decoder(self) -> RNNDecoder:
        return RNNDecoder(
